...
enum ExpType {Void, Integer, Boolean, Char, CharInt, String, Equal, UndefinedType, UndeclaredType};
...
typedef struct treeNode
{
	...
	struct treeNode* value; // value for said node (variable)
	bool ignore;
	bool ignoreWarn;
	bool isUsed;
	...
	bool notScope; //avoid making a scope for FOR loops
